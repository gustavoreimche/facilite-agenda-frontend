...
const Cabecalho = ({ date, atualiza, abrirModal, hardColor, openModalDespesa, openModalEntradas, openModalTotal }: Props) => {
    ...
    return (
        <div className="title">
            ...
            <div className="menu">
                <AccountMenu hardColor={hardColor} openModalDespesa={openModalDespesa} openModalTotal={openModalTotal} />
            </div>
        </div>
    )
