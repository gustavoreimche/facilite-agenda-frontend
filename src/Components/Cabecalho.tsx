...
const Cabecalho = ({ date, atualiza, abrirModal, hardColor, openModalDespesa, openModalEntradas, openModalTotal, openModalDespesas, openModalEntrada }: Props) => {
    ...
    return (
        <div className="title" onKeyDown={onkeydown}>
            ...
            <div className="menu">
                <AccountMenu hardColor={hardColor} openModalDespesa={openModalDespesa} openModalTotal={openModalTotal} openModalEntradas={openModalEntradas} openModalDespesas={openModalDespesas} openModalEntrada={openModalEntrada} />
            </div>
        </div>
    )
